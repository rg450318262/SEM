...
#display fit indices for the first 20 iterations of automatic model 
myframe %>% 
  head(25) %>% 
  kable(booktab = T,
        linesep = "",
        caption = 
          "Fit indices for the first 20 iterations of automatic model 
        modification (other 80 not shown)") %>%
  kable_styling(latex_options = "striped") %>% 
