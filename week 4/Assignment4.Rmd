...
Figure 12 displays the final model, which highlights in orange all the regression paths added in addition to the initial model.
...
```{r, fig.width=14, fig.height=10}
semPaths(semPlotModel(model.plot),
             style = "lisrel",
             rotation = 2,
             sizeLat = 6,
             sizeLat2 = 5,
...
Figure 13 displays the theoretical structure of the final model, showing how the psychological determinants influencing teacher's burnout.
...
I found SEM is beautiful blending of statistics and mindful sense-making. Indeed, they always go together. Yet, not often so well balanced as they are in SEM, for the scope of statistics I am familiar with. 
