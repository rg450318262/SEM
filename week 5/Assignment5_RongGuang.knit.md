...
\caption{(\#tab:unnamed-chunk-19)Fit indices for two subgroups, basline models}
\centering
...
\caption{(\#tab:unnamed-chunk-22)Factor loadings for both levels}
\centering
...
\caption{(\#tab:unnamed-chunk-25)Residual variance for both levels}
\centering
...
\caption{(\#tab:unnamed-chunk-28)Residual co-variance for both levels}
\centering
...
\caption{(\#tab:unnamed-chunk-31)Selected modification indices for determining baseline model}
\centering
