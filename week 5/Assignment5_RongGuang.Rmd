...
Results for this configural model (inv1.model) were as follows: MLM chi-square(401) = 939.696, CFI = 0.939, RMSEA = 0.046, and SRMR = 0.051.

## Impose equality constraints on factor loadings of configural model

### Constrain 20 common factor loadings equal (inv2.model)
